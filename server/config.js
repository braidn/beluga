...
app.post("/upload-image/:type", upload.single("file"), (req, res) => {
...
app.get("/delete-image/:product_id/:photo_name", function(req, res) {
  fs.unlink(
    `./public/assets/${req.params.product_id}/${req.params.photo_name}`,
    err => {
